    ...
    <div className="relative container mx-auto px-4 pt-16 pb-16">
      ...
      <div className="max-w-5xl mx-auto text-center space-y-8">
        <h1 className="text-5xl md:text-7xl lg:text-8xl gradient-title mb-6">
          Your Space to Write. <br /> Your Story to Tell.
        </h1>
        ...
        <div className="flex justify-center gap-4">
          ...
          <Link href="#features">
            <Button
              variant="outline"
              className="px-8 py-6 rounded-full border-black text-black hover:bg-purple-100"
            >
              Learn More
            </Button>
          </Link>
        ...
        <Card className="bg-gradient-to-r from-purple-100 to-purple-50">
          <CardContent className="p-12 text-center">
            <h2 className="text-3xl font-bold text-black mb-6">
              Start Lume-ing on Your Journey Today
            </h2>
