  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <form onSubmit={onSubmit} className="space-y-2  mx-auto">
        ...
        {isLoading && (
          <BarLoader className="mb-4" width={"100%"} color="purple" />
        )}
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            className={`py-5 md:text-md ${
              errors.title ? "border-purple-700" : ""
            }`}
          />
          {errors.title && (
            <p className="text-purple-700 text-sm">{errors.title.message}</p>
          )}
        </div>
        ...
        <div className="space-y-2">
          ...
          <Controller
            ...
            render={({ field }) => (
              <Select onValueChange={field.onChange} value={field.value}>
                <SelectTrigger className={errors.mood ? "border-purple-700" : ""}>
          ...
          />
          {errors.mood && (
            <p className="text-purple-700 text-sm">{errors.mood.message}</p>
          )}
        </div>
        ...
        <div className="space-y-2">
          ...
          />
          {errors.content && (
            <p className="text-purple-700 text-sm">{errors.content.message}</p>
          )}
        </div>
